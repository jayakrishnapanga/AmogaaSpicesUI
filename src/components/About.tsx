          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Amogaa Spices was born from a grandmother’s timeless dream.
                Inspired by her passion for authentic flavors and the richness
                of tradition, we began our journey in 2018 with a simple vision
                — to bring pure, handpicked, and carefully blended spices to
                every kitchen
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="border-l-4 border-saffron pl-6">
                ...
                <p className="text-muted-foreground">
                  Every spice in our collection is handpicked from the fertile
                  soils where it belongs—saffron from the valleys of Kashmir,
                  cardamom from the Western Ghats, and turmeric from the
                  sun-kissed fields of Tamil Nadu.
                </p>
              </div>
              ...
              <div className="border-l-4 border-turmeric pl-6">
                ...
                <p className="text-muted-foreground">
                  Our recipes for blending and processing have been passed down
                  through three generations, each adding their own touch while
                  preserving the essence that makes every dish a celebration.
                </p>
              </div>
              ...
              <div className="border-l-4 border-cinnamon pl-6">
                ...
                <p className="text-muted-foreground">
                  We believe that cooking is an act of love, and every meal
                  prepared with our spices carries the warmth of countless
                  families who have shared this passion for authentic flavors.
                </p>
              </div>
            </div>
          </div>
