      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-primary-foreground/80 mb-6 max-w-md">
              Bringing the authentic flavors of India to kitchens around the world. 
              Every spice tells a story, every meal becomes a memory.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2 text-primary-foreground/80 text-sm">
              ...
              <p>
                <a href="mailto:hello@amogaspices.com" className="hover:text-saffron transition-colors">
                  hello@amogaspices.com
                </a>
              </p>
            </div>
          </div>
        ...
        <div className="border-t border-primary-foreground/20 mt-8 pt-8 text-center">
          <p className="text-primary-foreground/60 text-sm">
            © 2024 Amoga Spices. All rights reserved. Crafted with love and tradition.
          </p>
        </div>
      </div>
    </footer>
